    ...
    <IonModal isOpen={isModalChangeCityOpen} cssClass={"modal"}>
      <div className="openedModal">
        ...
        <div className={"containerLink"}>
          <a className={"exampleLink"} target={"_blank"} href="https://openweathermap.org/weathermap?basemap=map&cities=true&layer=temperature&lat=53.9173&lon=27.5290&zoom=10">example</a>
        </div>
        <IonButton 
          color="success"
